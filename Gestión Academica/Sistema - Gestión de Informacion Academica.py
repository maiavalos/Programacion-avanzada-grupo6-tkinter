...
# Eliminar las siguientes líneas para quitar el campo de calificación
...
escuela_input.grid(row=3, column=1, padx=10, pady=10)  # Actualizar el índice de la fila

localidad_input = Entry(framecampos, textvariable=localidad)
localidad_input.grid(row=4, column=1, padx=10, pady=10)

provincia_input = Entry(framecampos, textvariable=provincia)
provincia_input.grid(row=5, column=1, padx=10, pady=10)
...
# Eliminar las siguientes líneas para quitar el label de calificación
# calificacionlabel = Label(framecampos, text="Calificación:")
# calificacionlabel.grid(row=3, column=0, sticky="e", padx=10, pady=10)

carreralabel = Label(framecampos, text="Carrera:")  # Actualizar el texto si es necesario
carreralabel.grid(row=3, column=0, sticky="e", padx=10, pady=10)  # Actualizar el índice de la fila

localidadlabel = Label(framecampos, text="Localidad:")
localidadlabel.grid(row=4, column=0, sticky="e", padx=10, pady=10)

provincialabel = Label(framecampos, text="Provincia:")
provincialabel.grid(row=5, column=0, sticky="e", padx=10, pady=10)
